...
geral <-read.csv("input/map_coordenades_coral_metagenome_6mai2019.csv", sep=",", header=TRUE)

# adding growth form info desse novo arquivo
data <- read.csv("input/refined_detailed_abundance_phyla_130_corais_matrix_porcentagem_prot_divided_17abr2019.csv", check.names=FALSE)
